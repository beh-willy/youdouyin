...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			...
			<li style="display:none;"><a href="#B" data-toggle="tab"><?php echo L('SEO_SETTING');?></a></li>
			<li style="display:none;"><a href="#C" data-toggle="tab"><?php echo L('TEMPLATE_SETTING');?></a></li>
		</ul>
