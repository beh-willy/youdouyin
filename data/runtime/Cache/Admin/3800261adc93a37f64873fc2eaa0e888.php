		   ...
		   <input type="hidden" name="nopasstime" value="<?php echo ($video['nopass_time']); ?>">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="number" name="price"  value="<?php echo ($video['price']); ?>">
						<span class="form-required">金币</span>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">是否推荐</label>
					<div class="controls">
						<label class="radio inline" for="active_true"><input type="radio" name="isrecommend" value="0" <?php if($video['isrecommend'] == '0'): ?>checked<?php endif; ?>  />否</label>
						<label class="radio inline" for="active_false"><input type="radio" name="isrecommend" value="1" <?php if($video['isrecommend'] == '1'): ?>checked<?php endif; ?> />是</label>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">是否为广告</label>
					<div class="controls">
						<label class="radio inline" for="is_ad"><input type="radio" name="is_ad" value="0" <?php if($video['is_ad'] == '0'): ?>checked<?php endif; ?>  />否</label>
						<label class="radio inline" for="is_ad"><input type="radio" name="is_ad" value="1" <?php if($video['is_ad'] == '1'): ?>checked<?php endif; ?> />是</label>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">广告跳转链接</label>
					<div class="controls">
						<input type="text" name="ad_url"  value="<?php echo ($video['ad_url']); ?>">
						<span class="form-required">视频类型为广告时必填！</span>
					</div>
				</div>
