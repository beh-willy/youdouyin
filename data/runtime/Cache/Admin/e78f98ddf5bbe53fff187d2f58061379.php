...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<!-- <li><a href="<?php echo U('Community/add');?>">圈子添加</a></li> -->
		</ul>
		
		<form class="well form-search" method="post" action="<?php echo U('Community/index');?>">
			排序：
			...
			关键字： 
			<input type="text" name="keyword" style="width: 200px;" value="<?php echo ($formget["keyword"]); ?>" placeholder="请输入圈子ID、会员ID">
			<input type="text" name="keyword1" style="width: 200px;" value="<?php echo ($formget["keyword1"]); ?>" placeholder="请输入圈子标题">
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
						...
						<td>
							<?php if($vo['videolink'] != '' ): ?><img src="<?php echo ($vo['thumb']); ?>" />
    							<?php else: ?> 
					...
					<!--<td><?php echo ($vo['likes']); ?></td>
						...
						<td align="center">
							<?php if($vo['videolink'] != '' ): ?><a href="javascript:void(0)" onclick="videoListen(<?php echo ($vo['id']); ?>)" >观看</a>
								|<?php endif; ?>
							<a href="<?php echo U('Community/edit',array('id'=>$vo['id'],'from'=>'index'));?>" >编辑</a>
							 <?php if($vo['isdel'] == '0'): ?><a href="javascript:void (0)" onclick="del(<?php echo ($vo['id']); ?>)" >删除</a><?php endif; ?>
							<!-- <a href="<?php echo U('Community/del',array('id'=>$vo['id']));?>" class="js-ajax-dialog-btn" data-msg="您确定要删除吗？">删除</a> -->
						</td>
