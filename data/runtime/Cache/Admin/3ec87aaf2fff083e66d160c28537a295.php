	...
	<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Video/add_post');?>">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<label class="radio inline" ><input type="radio" name="isrecommend" value="0" checked  />否</label>
					<label class="radio inline" ><input type="radio" name="isrecommend" value="1" >是</label>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">是否为广告</label>
				<div class="controls">
					<label class="radio inline" ><input type="radio" name="is_ad" value="0" <?php if($video['is_ad'] == '0'): ?>checked<?php endif; ?>  />否</label>
					<label class="radio inline"><input type="radio" name="is_ad" value="1" <?php if($video['is_ad'] == '1'): ?>checked<?php endif; ?> />是</label>
				</div>
			</div>
			<div class="control-group">
...
<script type="text/javascript">
	...
	function initCategory() {
		...
		// ajax请求所有分类
		$.get("/api/public", {
			service : "Category.GetCategory",num:0
