			...
			<div class="js-tabs-content">
				...
				<div>
					<fieldset>
						...
						<div class="control-group">
							<label class="control-label">导航按键名称</label>
							<div class="controls">				
								<input type="text" name="post[sitebarname]" value="<?php echo ($config['sitebarname']); ?>">导航按键名称，以|分开
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							<label class="control-label">广告间隔数</label>
							<div class="controls">
								<input type="text" name="post[ad_space]" value="<?php echo ($config['ad_space']); ?>"> 广告间隔数
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">金币名称</label>
							<div class="controls">				
								<input type="text" name="post[name_coin]" value="<?php echo ($config['name_coin']); ?>">视频点赞可兑换虚拟金币名称
							</div>
						</div>
						<!-- <div class="control-group">
							<label class="control-label">金币名称</label>
							<div class="controls">				
								<input type="text" name="post[name_votes]" value="<?php echo ($config['name_votes']); ?>">视频点赞可兑换虚拟票名称
							</div>
						</div> -->
						<div class="control-group">
						...
						<div class="control-group">
							<label class="control-label">客服wx</label>
							<div class="controls">				
								<input type="text" name="post[wxin]" value="<?php echo ($config['wxin']); ?>">官方客服微信
							</div>
						</div>
						<div class="control-group">
				...
				<div>
					<fieldset>
						...
						<div class="control-group">
							<label class="control-label">分享单页标题</label>
							<div class="controls">				
								<input type="text" name="post[video_share_title]" value="<?php echo ($config['video_share_title']); ?>"> 分享单页标题
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">分享单页说明</label>
							<div class="controls">				
								<script type="text/plain" id="container" name="post[video_share_explain]"><?php echo ($config['video_share_explain']); ?></script> 分享单页说明
							</div>
						</div>
						<textarea id="content1" name="post[video_share_explain]" style="display: none;"></textarea>
						<div class="control-group">
							<label class="control-label">分享链接话术</label>
							<div class="controls">				
								<input type="text" name="post[video_share_des]" value="<?php echo ($config['video_share_des']); ?>"> 分享链接话术
							</div>
						</div>
