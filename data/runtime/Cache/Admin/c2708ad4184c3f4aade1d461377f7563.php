...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li><a href="<?php echo U('Ads/add');?>">图片添加</a></li>
		</ul>
				...
				<tbody>
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
					   <!-- <td><input name="listorders[<?php echo ($vo['id']); ?>]" type="text" size="3" value="<?php echo ($vo['orderno']); ?>" class="input input-order"></td> -->
						...
						<td><?php echo ($ads_sort[$vo['sid']]); ?></td>
						<td><?php echo ($vo['name']); ?></td>
						

						<td><img width="150" height="50" src="<?php echo ($vo['thumb']); ?>" /></td>
						<td><?php echo ($vo['url']); ?></td>
						<td><?php echo ($vo['des']); ?></td>
						<td><?php echo (date("Y-m-d H:i:s",$vo["addtime"])); ?></td>

						<td align="center">	
							<a href="<?php echo U('Ads/edit',array('id'=>$vo['id']));?>" >编辑</a>
							 |
							  <a href="<?php echo U('Ads/del',array('id'=>$vo['id']));?>" class="js-ajax-dialog-btn" data-msg="您确定要删除吗？">删除</a>
