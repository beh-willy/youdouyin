				...
				<tbody>
					...
					<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td align="center">
							...
							<!--<a href="<?php echo U('Community/edit',array('id'=>$vo['id'],'from'=>'passindex'));?>" >编辑</a> -->
							 <?php if($vo['isdel'] == '0'): ?><a href="javascript:void (0)" onclick="xiajia(<?php echo ($vo['id']); ?>)" >下架</a><?php endif; ?>
							 |
