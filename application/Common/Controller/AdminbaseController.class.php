...
class AdminbaseController extends AppframeController {
     ...
     * @return string[]
     */
    protected function get_video_cover($filepath){

        //$filepath ='http://91lianmeng-1301794244.cos.ap-chengdu.myqcloud.com/video/794a8f67228cf5d792b7a091276cadbc.mp4';
        // $ffMpeg = FFMpeg::create(array(
        //     'ffmpeg.binaries' => '/usr/local/ffmpeg/bin/ffmpeg',
        //     'ffprobe.binaries' => '/usr/local/ffmpeg/bin/ffprobe',
        //     'timeout' => 3600, // The timeout for the underlying process
        //     'ffmpeg.threads' => 12,   // The number of threads that FFMpeg should use1
        // )
        //     );

        $file = 'public/upload/'.date('Ymdhis',time()).rand(10000,99999).'.png';
        $output =  SITE_PATH .$file;
        $command ="/usr/local/ffmpeg/bin/ffmpeg  -i {$filepath} -frames:v 1 -ss 1 -f image2  {$output}";
